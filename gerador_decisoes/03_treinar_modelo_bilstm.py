...
with open('../modelos/dados_treino_mincount_10_mauro_campbell.pkl', 'rb') as fp:
...
nome_modelo = "bilstm-w2v-wordlevel-mincount10-{}-len-{}-{}-lr-{}-optimizer-{}-batchsize-{}-mauro_campbell.model".format(tamanho_sentencas, units1, units2, learning_rate, optimizer,
                                                                                                                   batchsize)
